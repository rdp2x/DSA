Java is platform independent because java isn't directly compiled into machine code, rather first it get compiled into something called _byte code_ and that byte code then compiles into machine code.
